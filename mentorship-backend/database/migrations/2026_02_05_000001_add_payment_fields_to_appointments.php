...
return new class extends Migration
{
    public function up()
    {
        Schema::table('appointments', function (Blueprint $table) {
            ...
            // Modify status enum to include pending_payment
            $table->enum('status', ['pending_payment', 'scheduled', 'completed', 'cancelled', 'rescheduled'])->default('pending_payment')->change();
        });
    }
