                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            const Text("Uplifts", style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Color(0xFF6B4EE6))),
                          ],
                        ),
                        const SizedBox(height: 10),
                        Text("Join Uplifts and start your journey", style: TextStyle(color: Colors.grey.shade600, fontSize: 14)),
                      ],
                    ),
                  ),
  ...
  Widget _socialButton(String platform, Color color, IconData icon) {
    return InkWell(
      onTap: () {
        ...
        ApiService.startOAuth(provider, role: _selectedRole).then((opened) {
          if (!opened) {
