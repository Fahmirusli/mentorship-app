                  ...
                  {mentor.next_available_slot && (
                    <div className="mb-3 px-3 py-2 bg-green-50 border border-green-100 rounded-lg">
                      <p className="text-xs text-green-700 font-medium">
                        Next: {new Date(mentor.next_available_slot.date.replace(/-/g, '/')).toLocaleDateString('en-MY', { weekday: 'short', day: 'numeric', month: 'short' })}
                        {' · '}{mentor.next_available_slot.start_time} – {mentor.next_available_slot.end_time}
                      </p>
